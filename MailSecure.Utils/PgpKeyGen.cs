...
namespace MailSecure.Security
{
    public class PgpKeyGen
    {
        ...
        public static void generateKeys(String Identity, String Password, String KeyPath)
        {
            ...
            BufferedStream pubout = new BufferedStream(new FileStream(KeyPath + "\\pubring.gpg", System.IO.FileMode.Create));
            pkr.Encode(pubout);
            pubout.Close();

            // Generate private key, dump to file.
            PgpSecretKeyRing skr = krgen.GenerateSecretKeyRing();
            BufferedStream secout = new BufferedStream(new FileStream(KeyPath + "\\secring.gpg", System.IO.FileMode.Create));
            skr.Encode(secout);
            secout.Close();
        }
